...
(function (global, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined') {
    // CommonJS
    var moduleJyfLargefileCrafter = require("JyfLargefileCrafter");
    modules.exports = factory(moduleJyfLargefileCrafter);
    ...
    global.JyfLargefileCrafter = factory();
  }
})(void 0, function () {
  'use strict';
  ...
  */
  function fileReader() {
    var READ_AS_TEXT = 1;
    var READ_AS_BINARY_STRING = 2;
    var READ_AS_ARRAY_BUFFER = 3;
    this.reader = [];
    this.flag = [];
    this.sizeMap = [];
    this.fileCount = 0;
  ...
  fileReader.prototype.readAsText = function (file, callback, step) {
  ...
  fileReader.prototype.initReader = function (type, index, step, file, callback) {
    var start = 0,
      Reader = this,
      resolveProcess = function resolveProcess(event) {
      ...
      readBlob = function readBlob(type, index, step, file) {
